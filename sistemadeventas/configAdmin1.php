    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">Inversiones R&P</small></h1>
            </div>
            <!-- Nav tabs -->
            ...
            <li role="presentation"><a href="#Clientes" role="tab" data-toggle="tab">Datos Clientes</a></li>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>';
                                                                ...
                                                                while($UsP=mysqli_fetch_array($conUs)){
                                                                         //echo $UsP['Nombre'];
                                                                    //echo '<a href="#Cliente" role="tab" data-toggle="tab">'.$UsP['Nombre'].'</a>';
                                                                 //echo   '<div id="node"/>';

                                                                    echo '<a href="#Cliente" onclick="add(this);" nombre="cli" id="cli" value="" role="tab" data-toggle="tab">'.$UsP['Nombre'].'</a>';
                                          ...
                                          ?>
                                            <script>
                                             var array_valores = Array();
                                               ...
                                               function add(x)
                                                {                
                                                    var cl = document.getElementById('cli');
                                                    array_valores.push(x.innerHTML);                                                             
                                                   cl.value = array_valores.toString();  
                                                   $cs=cl.value;                  
                                                  alert (cl.value);
                                  ...
                                  <table class="table table-bordered">
                                      ...
                                      <tbody>
                                          <?php
                                            ...
                                            //aquie me falta la variable con la que quiero filtrar en la DB por la consulta
                                          $conUs= ejecutarSQL::consultar("select * from cliente ");
                                            $con=1;
                                            while($UsP=mysqli_fetch_array($conUs)){
                                                echo '
                                                    <div>
