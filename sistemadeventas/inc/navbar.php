...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs"><!-- Menu computadoras y tablets -->
            <div class="col-xs-4">
                ...
                <p class="text-navbar tittles-pages-logo">Inversiones R&P</p>
            </div>
            <div class="col-xs-8">
                    ...
                    <div class="contenedor-tr">
                        ...
                        <?php
                            if(!$_SESSION['nombreAdmin']==""){
                                echo ' 
                                    <a href="configAdmin1.php" class="table-cell-td">Administración</a>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        ...
        <ul class="list-unstyled text-center">
            ...
            <?php 
                if(!$_SESSION['nombreAdmin']==""){
                    echo '<li><a href="configAdmin1.php">Administración</a></li>';
